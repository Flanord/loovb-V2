...
<div class="home-page pb-5">
    <div class="hh-search-form-wrapper">
        <div class="ots-slider-wrapper" data-style="full-screen" data-slider="ots-slider">
            <div class="ots-slider">
                        <div class="item">
                            <div class="outer has-background-image" data-src="/images/bgr-callgg-action1.jpg" style="background-image: url(/images/bgr-call-action1.jpg)"></div>
                            <div class="inner">
    ...
    @if(!empty($page_id))
        ...
        <div class="container mt-5">
            <div class="call-to-action pl-4 pr-4 has-background-image" data-src="{{ $cta_background_url }}" style="background-image: url('{{$cta_background_url}}')">
                <div class="row">
                    <div class="col-lg-8">

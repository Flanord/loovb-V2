        ...
        <div class="row">
                ...
                <a href="{{ $url }}">
                    <div class="thumbnail">
                        ...
                        @if($item->is_featured == 'on')
                            <div class="is-featured">{{ get_option('featured_text', __('Nouveauté')) }}</div>
                        @endif
                    </div>
                </a>
            </div>
            <div class="col-12 col-lg-7">
                <div class="detail">
                    ...
                    <p class="address text-overflow"><i class="fe-map-pin mr-1"></i>{{ get_translate($item->location_address) }}</p>
                    ...
                    <div class="footer-content d-flex align-items-center justify-content-between">
                        ...
                        <div class="price-wrapper {{ (empty($item->rating) || !enable_review()) ? 'left' : '' }}">
                            <span class="price">{{ convert_price($item->base_price) }}</span><span class="unit">/{{get_car_unit()}}</span>
                        </div>
                    </div>
                </div>
            </div>

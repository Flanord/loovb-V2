...
<div class="row">
    <div class="col-12 col-sm-6">
        <div class="form-group">
            <label for="user_first_name">{{__('Prénom')}} <span class="f12">{{__('(Optionnel)')}}</span></label>
...
<div class="form-group">
    ...
    <div class="input-group">
        ...
        <div class="input-group-append">
            <button class="btn btn-dark waves-effect waves-light" type="button">{{__('Créer un mot de passe')}}</button>
        </div>
    </div>
</div>

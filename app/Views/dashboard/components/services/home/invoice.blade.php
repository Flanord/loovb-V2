...
<div class="tab-content">
    <div class="tab-pane active" id="tab-invoice-payment-info">
        <div class="payment-item">
            <div class="item row align-items-center">
                <div class="col-4">
                    <h5 class="title">{{__('ID de réservation')}}</h5>
                </div>
                <div class="col-8">
            ...
            <div class="item row align-items-center">
                <div class="col-4">
                    <h5 class="title">{{__('Nom du service')}}</h5>
                </div>
                <div class="col-8">
            ...
            <div class="item row align-items-center">
                <div class="col-4">
                    <h5 class="title">{{__('Nombre Invité')}}</h5>
                </div>
                <div class="col-8">
            ...
            @if($serviceObject->booking_type == 'per_night')
                <div class="item row align-items-center">
                    <div class="col-4">
                        <h5 class="title">{{__('Enregistrement / départ')}}</h5>
                    </div>
                    <div class="col-8">
            ...
            <div class="item row align-items-center">
                <div class="col-4">
                    <h5 class="title">{{__('Mode de paiement')}}</h5>
                </div>
                <div class="col-8">
                    @if(is_object($paymentObject))
                        <span>{{ $paymentObject::getName() }}</span>
                    @else
                        <span>{{ __('Indisponible') }}</span>
                    @endif
                </div>
            </div>
            ...
            <div class="item row align-items-center">
                <div class="col-4">
                    <h5 class="title">{{__('Prix de base')}}</h5>
                </div>
                <div class="col-8">
            ...
            @if ($extraPrice > 0)
                <div class="item row align-items-center">
                    <div class="col-4">
                        <h5 class="title">{{__('Supplémentaire')}}</h5>
                    </div>
                    <div class="col-8">
    ...
    <div class="tab-pane" id="tab-invoice-customer">
        <div class="payment-item">
            ...
            <div class="item row align-items-center">
                <div class="col-4">
                    <h5 class="title">{{__('Télephone')}}</h5>
                </div>
                <div class="col-8">

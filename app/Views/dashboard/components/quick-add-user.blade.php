...
<div id="hh-add-new-coupon-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <form class="form form-action relative" action="{{ dashboard_url('add-new-user') }}">
            @include('common.loading')
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">{{__('Ajouter nouveau utilisateur')}}</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <label for="user_first_name">{{__('Prénom')}} <span class="f12">(Optional)</span></label>
                                <input type="text" class="form-control" id="user_first_name" name="user_first_name">
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <label for="user_last_name">{{__('Nom')}} <span class="f12">{{__('(Optional)')}}</span></label>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="user_role" id="user_role" class="form-control wide" data-plugin="customselect">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control has-validation"
                                   data-validation="required|min:6:m" data-plugin="password" id="user_password" name="user_password">

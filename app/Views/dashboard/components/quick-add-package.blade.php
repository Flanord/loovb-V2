        ...
        <form class="form form-action relative" action="{{ dashboard_url('add-new-package') }}">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">{{__('Ajouter un nouveau package')}}</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  id="package_price" name="package_price" placeholder="{{__('Leave empty for Free')}}">
                    </div>
                    <div class="form-group">
                        <label for="package_time">
                            {{__('Temps de paquet (jours)')}}
                        </label>
                        <input type="text" class="form-control"  id="package_time" name="package_time" placeholder="{{__('Leave empty for Unlimited')}}">
                    </div>
                    <div class="form-group">

    ...
    <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <form class="app-search" action="{{ dashboard_url('all-booking') }}" method="get">
                <div class="app-search-box">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="{{__('Recherche réservation ...')}}" name="_s"
                               value="{{ $search }}">
        ...
        <li id="hh-dropdown-notification" class="dropdown notification-list"
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-lg">
                ...
                @else
                    <p class="text-muted text-center">{{__('Pas encore de notification')}}</p>
            @endif
            <!-- All-->
        ...
        <li class="dropdown user-nav-list">
            ...
            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                ...
                <div class="dropdown-header noti-title">
                    <h6 class="text-overflow">{{__('Bienvenu(e) !')}}</h6>
                </div>
                <!-- item-->
                <a href="{{ url('/') }}" class="dropdown-item notify-item">
                    <i class="fe-home"></i>
                    <span>{{__("Aller à l'accueil")}}</span>
                </a>
                <!-- item-->

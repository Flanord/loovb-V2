...
<div class="right-bar">
    <div class="rightbar-title">
        ...
        <h5 class="m-0 text-white">{{__('Paramètres')}}</h5>
    </div>
    <div class="slimscroll-menu">
        ...
        <!-- Settings -->
        <hr class="mt-0"/>
        <h5 class="pl-3">{{__('Réglages rapides')}}</h5>
        <hr class="mb-0"/>
        <div class="p-3">
            <form action="{{ dashboard_url('save-quick-settings') }}"
                ...
                <div class="mb-2">
                    <label for="q_main_color">{{__('Couleur principale')}}</label><br/>
                ...
                <div class="mb-2">
                    <label for="q_enable_review">{{__("Activer commentaire")}}</label><br/>
        ...
        <!-- Timeline -->
        <hr class="mt-0"/>
        <h5 class="px-3">{{__('Dernières notifications')}}</h5>
        <hr class="mb-0"/>
        <div class="pl-3 pr-3">
            <div class="inbox-widget notification-list ">
                ...
                @if(count($allNotifications['results']))
                    ...
                    @endforeach
                @else
                    <p class="text-muted"><i>{{__('Pas encore de notification')}}</i></p>
                @endif

                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <h4 class="page-title">
                                ...
                                <a class="btn btn-info btn-xs waves-effect waves-light ml-1"
                                   data-toggle="collapse" href="#hh-media-add-new" aria-expanded="true">{{__('Ajouter')}}
                                </a>
                            </h4>
                            <?php
                            ...
                            <div class="hh-all-media-render relative">
                                ...
                                @else
                                    ...
                                    <div class="action-toolbar">
                                        <form class="hh-form form-inline" action="{{dashboard_url('media-bulk-actions')}}" data-target="#table-my-media" method="post">
                                        ...
                                        <tr>
                                            <th data-priority="-1" class="hh-checkbox-td">
                                                <div class="checkbox checkbox-success hh-check-all">
                                                    ...
                                                    <label for="hh-checkbox-all--my-media"><span class="d-none">{{__('Check All')}}</span></label>
                                                </div>
                                            </th>
                                            <th data-priority="1">
        ...
        <div class="modal-content">
            <form class="form form-action form-update-media-item-modal relative"
                ...
                <div class="modal-header">
                    <h4 class="modal-title">{{__('Détails de la pièce jointe')}}</h4>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit"
                            class="btn btn-info waves-effect waves-light">{{__('Modifier')}}
                    </button>
                </div>
            </form>
        </div>

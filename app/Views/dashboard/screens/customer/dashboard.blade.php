    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="page-title-box">
                <h4 class="page-title">{{ __('Bienvenu(e) :username', ['username' => get_username($user->getUserId())]) }}!</h4>
            </div>
                <div class="card card-box">
                    <h4 class="header-title mb-3">{{__('Votre dernière réservation')}}</h4>
                    <div class="hh-slimscroll" data-max-height="350px" data-min-height="150px">
                        ...
                        <table class="table table-large mb-0 dt-responsive nowrap w-100 @if($allBooking['total'] <= 0) no-data @endif"
                            ...
                            <tr>
                                ...
                                <th data-priority="6">{{__('Enregistrement / départ')}}</th>
                ...
                <div class="card card-box">
                    <h4 class="header-title mb-3">{{__('Vos notifications')}}</h4>
                    <div class="hh-slimscroll" data-max-height="350px" data-min-height="150px">
                        @php
                            enqueue_style('datatables-css');
                            enqueue_script('datatables-js');
                        ...
                        <table class="table table-large mb-0 dt-responsive nowrap w-100 @if($allNotifications['total'] <= 0) no-data @endif"
                            ...
                            <tr>
                                ...
                                <th data-priority="-1" class="text-center">{{__('Créé à')}}</th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            @else
                                <tr>
                                    <td colspan="5">
                                        <h4 class="mt-3 text-center">{{__('Pas encore de messages.')}}</h4>
                                    </td>
                                </tr>
                            @endif
                            </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">{{__('les détails de réservation')}}</h4>

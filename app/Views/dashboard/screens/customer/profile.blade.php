...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            @include('dashboard.components.breadcrumb', ['heading' => __('Profil')])
            {{--Start Content--}}
            @php
                        ...
                        <form action="{{ dashboard_url('update-your-avatar') }}" class="form form-action">
                            ...
                            <div class="avatar-preview">
                                <div class="media align-items-center mb-2">
                                    <img src="{{ get_user_avatar($user_id, [85,85]) }}" class="avatar" alt="{{__('Photo')}}">
                                    <div class="media-body">
                                        <h4 class="mb-1 mt-3">{{ get_username($user_id) }}</h4>
                                        <p class="text-muted">{{ $current_user->getUserLogin() }}</p>
                                    </div>
                                </div>
                                <a href="javascript:void(0)" class="change-avatar">{{__('Changer votre photo')}}</a>
                            ...
                            <div class="text-left mt-3">
                                <h4 class="font-13 text-uppercase">{{__('Apropos de moi:')}}</h4>
                                ...
                                <p class="text-muted mb-2 font-13"><strong>{{__('Nom et prénom:')}}</strong>
                                    <span class="ml-2"
                    ...
                    <div class="card relative p-3">
                        <form action="{{ dashboard_url('update-password') }}" class="form form-action mt-1"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="new_re_password">{{__('Confirmation mot de passe')}}</label>
                    ...
                    <div class="card relative p-3">
                        ...
                        <form action="{{ dashboard_url('update-your-profile') }}" class="form form-action mt-3"
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-4">
                                    <div class="form-group">
                                        <label for="mobile">{{__('Télephone')}}</label>
                                ...
                                <div class="col-6 col-md-6">
                                    <div class="form-group">
                                        <label for="mobile">{{__('Adresse')}}</label>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="location">{{__('Adresse')}}</label>
                                        @php
                                        ...
                                        <select name="location" id="location" class="form-control wide" data-plugin="customselect">
                                            <option value="">{{__('---- Selectionner pays ----')}}</option>

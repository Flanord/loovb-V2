...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            @include('dashboard.components.breadcrumb', ['heading' => __('Toutes les réservations')])
            {{--Start Content--}}
            <div class="card-box">
                <div class="header-area d-flex align-items-center">
                    <h4 class="header-title mb-0">{{__('Toutes les réservations')}}</h4>
                    <form class="form-inline right d-none d-sm-block" method="get">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="_s"
                                   value="{{ $search }}"
                                   placeholder="{{__('Recherche par  code de réservation, e-mail')}}">
                        </div>
                    ...
                    @if ($allBooking['total'])
                        @foreach ($allBooking['results'] as $item)
                            ...
                            <tr>
                                ...
                                <td class="align-middle"><span class="exp">{{ get_translate($item->booking_description) }}</span></td>
                                <td class="align-middle text-center">
                                    <div class="booking-status {{ $item->status }}"><span class="exp">{{ __($bookingStatus['label']) }}</span></div>
                                </td>
                                <td class="align-middle text-center">

        ...
        <div class="content">
                ...
                <div class="row">
                    <div class="col-md-6 col-xl-3">
                        <div class="card-box card-balance">
                            <i class="fa fa-info-circle float-right" data-toggle="tooltip"
                               ...
                               data-original-title="Vous pouvez effectuer un paiement avec ce solde"></i>
                            <h4 class="mt-0 font-16">{{__('Solde')}}</h4>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card-box card-net-earning">
                            <i class="fa fa-info-circle float-right" data-toggle="tooltip"
                               data-placement="bottom" title=""
                               data-original-title="Montant total du propriétaire après déduction de tous les frais (commission) pour l'administrateur"></i>
                            <h4 class="mt-0 font-16">{{__('Revenu')}}</h4>
                            <h2 class="my-3 text-center">
                                {{ current_currency('symbol') }}
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card-box card-earning">
                            <i class="fa fa-info-circle float-right" data-toggle="tooltip"
                               data-placement="bottom" title=""
                               data-original-title="Votre montant total"></i>
                            <h4 class="mt-0 font-16">{{__('Gain')}}</h4>
                            <h2 class="my-3 text-center">
                                {{ current_currency('symbol') }}
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card-box card-payout">
                            <i class="fa fa-info-circle float-right" data-toggle="tooltip"
                               data-placement="bottom" title="" data-original-title="Le total des retraits"></i>
            ...
            <div class="card-box">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="header-title mb-3">{{__('Analyse des réservations')}}</h4>
                    @php
                ...
                <div class="hh-slimscroll" data-max-height="350px">
                    ...
                    <table class="table table-large mb-0 dt-responsive nowrap w-100" data-plugin="datatable"
                        ...
                        <tr>
                            ...
                            <th data-priority="6">{{__('Arrivée/Départ')}}</th>
                        ...
                        @else
                            <tr>
                                <td colspan="7">
                                    <h4 class="mt-3 text-center">{{__('Pas encore de réservations.')}}</h4>
                                </td>
                            </tr>
                        @endif
                        </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">{{__('Detail Réservation')}}</h4>

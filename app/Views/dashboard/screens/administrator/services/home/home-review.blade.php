...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            @include('dashboard.components.breadcrumb', ['heading' => __('Accueil Avis')])
            {{--Start Content--}}
            <div class="card-box">
                @if(enable_review())
                    <div class="header-area d-flex align-items-center">
                        <h4 class="header-title mb-0">{{__('Tous les avis')}}</h4>
                        <form class="form-inline right d-none d-sm-block" method="get">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="_s"
                                       value="{{ $search }}"
                                       placeholder="{{__('Recherche par identifiant, titre')}}">
                            </div>
                    ...
                    <table class="table table-large mb-0 dt-responsive w-100" data-plugin="datatable"
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownFilterStatus">
                                        <a class="dropdown-item"
                                           href="{{ remove_query_arg('status') }}">{{__('Toutes')}}</a>
                                        <?php
                        ...
                        @if ($comments['total'])
                                        ...
                                        <div class="dropdown dropleft">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item hh-link-action hh-link-delete-review text-danger"
                                                   ...
                                                   data-confirm-question="{{__('Voulez-vous vraiment supprimer cet avis?')}}"
                            ...
                            <tr>
                                <td colspan="7">
                                    <h4 class="mt-3 text-center">{{__("Pas encore d'avis.")}}</h4>
                                </td>
                            </tr>
                        @endif
                        </tbody>
                ...
                @else
                    {{__('Veuillez activer l'option de révision dans les paramètres pour utiliser cette fonction')}}
                @endif
            </div>
            {{--End content--}}

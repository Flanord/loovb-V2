...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            @include('dashboard.components.breadcrumb', ['heading' => __('Type de maison')])
            {{--Start Content--}}
            @php
                            ...
                            <tr>
                                <td class="align-middle">
                                    <div class="media align-items-center">
                                        @if(!empty($imageID))
                                            @php $imageUrl = get_attachment_url($imageID); @endphp
                    ...
                    <div class="modal-content">
                        <form class="form form-action form-update-term-modal relative form-translation"
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">{{__('Mettre à jour le type de domicile')}}</h4>

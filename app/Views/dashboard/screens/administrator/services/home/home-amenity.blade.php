...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            @include('dashboard.components.breadcrumb', ['heading' => __('Équipement de la maison')])
            {{--Start Content--}}
            @php
            ...
            <div class="card-box">
                ...
                <table class="table table-large mb-0 dt-responsive nowrap w-100" data-plugin="datatable"
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a href="javascript:void(0)" class="dropdown-item" data-toggle="modal"
                                               ...
                                               data-target="#hh-update-home-amenity-modal">{{__('Modifier')}}</a>
                    ...
                    @else
                        <tr>
                            <td colspan="3">
                                <h4 class="mt-3 text-center">{{__('Pas encore de terme.')}}</h4>
                            </td>
                        </tr>
                    @endif
                    </tbody>
                    ...
                    <div class="modal-content">
                        <form class="form form-action form-update-term-modal relative form-translation"
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">{{__('Mettre à jour des équipements de la maison')}}</h4>
                            ...
                            <div class="modal-footer">
                                <button type="submit"
                                        class="btn btn-info waves-effect waves-light">{{__('Valider')}}
                                </button>
                            </div>
                        </form>
                    </div>

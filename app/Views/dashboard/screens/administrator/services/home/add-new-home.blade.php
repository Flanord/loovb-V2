...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            {{--Start Content--}}
            @include('dashboard.components.breadcrumb', ['heading' => __('Ajouter une nouvelle maison')])
            @if (!$newHome)
                <div class="card-box">
                    <div class="alert alert-danger">{{__('Impossible de créer une nouvelle maison')}}</div>
                </div>
            @else
                @php

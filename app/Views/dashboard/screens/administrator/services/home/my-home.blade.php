...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            @include('dashboard.components.breadcrumb', ['heading' => __('Mes maisons')])
            {{--Start Content--}}
            <div class="card-box">
                <div class="header-area d-flex align-items-center">
                    <h4 class="header-title mb-0">{{__('Toutes les maisons')}}</h4>
                ...
                <div class="action-toolbar">
                    <form class="hh-form form-inline" action="{{dashboard_url('home-bulk-actions')}}" data-target="#table-my-home" method="post">
                ...
                <table id="table-my-home" class="table table-large mb-0 dt-responsive nowrap w-100" data-plugin="datatable"
                       data-paging="false"
                       data-export="on"
                    ...
                    <tr>
                        ...
                        <th data-priority="-1" class="hh-checkbox-td">
                            <div class="checkbox checkbox-success hh-check-all">
                                ...
                                <label for="hh-checkbox-all--my-home"><span class="d-none">{{__('Check All')}}</span></label>
                            </div>
                        </th>
                        <th data-priority="1">
                                ...
                                <td class="align-middle">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h5 class="m-0"><a href="{{ get_home_permalink($homeID, $item->post_slug) }}"

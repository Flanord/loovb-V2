...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            {{--Start Content--}}
            @include('dashboard.components.breadcrumb', ['heading' => __('Ajouter une nouvelle voiture')])
            @if (!$newCar)
                <div class="card-box">
                    <div class="alert alert-danger mb-0">{{__('Impossible de créer une nouvelle voiture')}}</div>
                </div>
            @else
                @php

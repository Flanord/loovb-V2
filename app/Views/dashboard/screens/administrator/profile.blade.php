...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            @include('dashboard.components.breadcrumb', ['heading' => __('Mon profil')])
            {{--Start Content--}}
            @php
                    ...
                    <div class="profile-preview card relative p-3  bg-pattern-1">
                        <form action="{{ dashboard_url('update-your-avatar') }}" class="form form-action">
                            ...
                            <div class="avatar-preview">
                                ...
                                <a href="javascript:void(0)" class="change-avatar">{{__('Changer Avatar')}}</a>
                            ...
                            <div class="text-left mt-3">
                                ...
                                <p class="text-muted mb-2 font-13"><strong>{{__('Nom complet:')}}</strong>
                                    <span class="ml-2"
                    ...
                    <div class="card relative p-3">
                        ...
                        <form action="{{ dashboard_url('update-your-profile') }}" class="form form-action mt-3"
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-4">
                                    <div class="form-group">
                                        <label for="mobile">{{__('Téléphone')}}</label>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="location">{{__('Pays')}}</label>
                                        @php

        ...
        <div class="content mt-2">
            ...
            <div class="card-box">
                <div class="header-area">
                    <h4 class="header-title">{{__('Compresse TinyPNG')}}</h4>
                    <p class="description mb-0">{{__('TinyPNG utilise des techniques de compression intelligentes avec perte pour réduire la taille du fichier de vos fichiers image')}}</p>
                    <p class="description">{!! balanceTags(__('Obtenez votre clé API sur <a target="_blank" href="https://tinypng.com/developers">https://tinypng.com/developers</a>')) !!}</p>
                </div>
                <div class="row">
                    <?php
                    ...
                    @if($enable_tinypng == 'on')
                        <div class="col-12 col-md-6">
                            ...
                            <div class="alert alert-danger">
                                {{__("Votre clé API n'est pas valide")}}
                            </div>
                            <?php
                            }
                            ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                <p class="text-muted mb-1 text-truncate">{{__('Comprimé')}}</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div>

                    ...
                    <div class="card-body p-4">
                        <ul class="nav nav-tabs nav-bordered nav-justified">
                            <li class="nav-item active">
                                <a href="#system-tool-system" data-toggle="tab" aria-expanded="false" class="nav-link active">{{__('System Tools')}}</a>
                            </li>
                            <li class="nav-item">
                                <a href="#system-tool-import" data-toggle="tab" aria-expanded="true" class="nav-link">{{__('Import Data')}}</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane active" id="system-tool-system">
                                <form action="{{url('system-tools')}}" class="form form-action relative">
                                    ...
                                    <div class="form-content mt-4">
                                        <div class="form-group">
                                            <div class="radio radio-success">
                                                <input type="radio" name="system_tool" value="clear_cache" id="system-clear-cache" checked>
                                                <label for="system-clear-cache">{{__('Clear All Cache')}}</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="radio radio-success">
                                                <input type="radio" name="system_tool" value="clear_view" id="system-clear-view">
                                                <label for="system-clear-view">{{__('Clear View Cache')}}</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="radio radio-success">
                                                <input type="radio" name="system_tool" value="update_version" id="system-version">
                                                <label for="system-version">{{__('Update New Version')}}</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="radio radio-success">
                                                <input type="radio" name="system_tool" value="symlink" id="system-symlink">
                                        ...
                                        @if(app()->isDownForMaintenance())
                                            <div class="form-group">
                                                <div class="radio radio-success">
                                                    <input type="radio" name="system_tool" value="on_coming" id="system-off-coming">
                                                    <label for="system-off-coming">{{__('Turn Off Coming Soon')}}</label>
                                                </div>
                                            </div>
                                        @else
                                            <div class="form-group">
                                                <div class="radio radio-success">
                                                    <input type="radio" name="system_tool" value="off_coming" id="system-on-coming">
                                    ...
                                    <div class="form-group mt-3">
                                        <input type="password" id="system-password" class="form-control has-validation" data-validation="required" name="password" placeholder="{{__('Enter System Password')}}">
                                    </div>
                                    <div class="form-group mt-4">
                                        <input type="submit" name="sm" class="btn btn-danger btn-block" value="{{__('Run')}}">
                                    </div>
                            ...
                            <div class="tab-pane" id="system-tool-import">
                                ...
                                <div class="awe-import-progress">
                                    ...
                                    <div class="form-group mt-3">
                                        <input type="password" id="system-password-import" class="form-control has-validation" data-validation="required" name="password" placeholder="{{__('Enter System Password')}}">
                                    </div>
                                    <div class="buttons">
                                        <a href="{{ url('/') }}" class="btn btn-success btn-block" id="awe_import_demo"
                                           data-action="{{ url('import-data') }}" data-confirm="{{__('Note: Your database will be reset before import demo data. Are you sure want to install demo data?')}}">{{__('Import Data')}}</a>
                                    </div>
                                </div>
                            </div>
                        </div>

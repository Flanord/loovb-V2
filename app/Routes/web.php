...
Route::group(['prefix' => Config::get('awebooking.prefix_dashboard'), 'middleware' => ['authenticate', 'locale']], function () {
    ...
    Route::get('get-terms/car-type', 'TermController@_getTerms')->name('car-type');
    Route::get('get-terms/car-equipment', 'TermController@_getTerms')->name('car-equipment');
    Route::get('get-terms/car-feature', 'TermController@_getTerms')->name('car-feature');
    ...
    Route::get('review/car', 'CommentController@_getListReview')->name('review-car');
    ...
    Route::get('partner-registration/{page?}', 'UserController@_partnerRegistration')->name('partner-registration');

    Route::post('get-partner-info', 'UserController@_getPartnerInfo')->name('get-partner-info');

    Route::post('approve-partner', 'UserController@_approvePartner')->name('approve-partner');
...
Route::group(['prefix' => Config::get('awebooking.prefix_dashboard'), 'middleware' => ['authenticate', 'locale', 'IsExperienceEnable']], function () {
...
Route::group(['prefix' => Config::get('awebooking.prefix_dashboard'), 'middleware' => ['authenticate', 'locale', 'IsHomeEnable']], function () {
...
Route::group(['prefix' => Config::get('awebooking.prefix_dashboard'), 'middleware' => ['authenticate', 'locale', 'IsCarEnable']], function () {
...
Route::group(['middleware' => ['locale', 'HtmlMinifier']], function () {
// Notification
...
//Experience Route
Route::group(['middleware' => ['locale', 'IsExperienceEnable', 'HtmlMinifier']], function () {
...
//Home Route
Route::group(['middleware' => ['locale', 'IsHomeEnable', 'HtmlMinifier']], function () {
...
//Car Route
Route::group(['middleware' => ['locale', 'IsCarEnable', 'HtmlMinifier']], function () {
